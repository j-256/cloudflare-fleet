...
const STATIC_PRESENTATION = Object.freeze({
  [FLEET_INTENT_SAVE_STATUS.FAILED]: Object.freeze({
    label: "Save failed",
    modifier: "failed",
    title: "Fleet intent could not be saved to project state",
  }),
  [FLEET_INTENT_SAVE_STATUS.OFFLINE]: Object.freeze({
    label: "Save unavailable",
    modifier: "offline",
    title: "The session broker is offline; fleet intent cannot be saved",
  }),
  ...
  [FLEET_INTENT_SAVE_STATUS.UNAVAILABLE]: Object.freeze({
    ...
    title: "This session can inspect fleet intent but has no project-state broker",
  }),
  [FLEET_INTENT_SAVE_STATUS.UNSAVED]: Object.freeze({
    label: "Not saved yet",
    modifier: "unsaved",
    title: "No fleet intent has been saved to project state",
  }),
})
...
export function resolveIntentSaveStatus(options) {
  ...
  if (!options.usesBroker) return FLEET_INTENT_SAVE_STATUS.UNAVAILABLE
...
export function intentSaveStatusPresentation(status, options = {}) {
  if (status === FLEET_INTENT_SAVE_STATUS.SAVED) {
    ...
    return {
      ...
      modifier: "saved",
      title: savedAtLabel
        ? `Fleet intent was saved to project state ${savedAtLabel}`
        : "Fleet intent is saved to project state",
    }
  }
